...
namespace SporSalonuYonetim_web.Controllers
{
    public class AntrenorController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Ad,Soyad,UzmanlikAlanlari,Email")] Antrenor antrenor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Ad,Soyad,UzmanlikAlanlari,Email")] Antrenor antrenor)
        {
            if (id != antrenor.Id)
            {
                return NotFound();
